...
namespace HCI2012
{
    ...
    public partial class MainWindow
    {
        ...
        /// <summary>
        /// The minumum number of seconds in the _video buffer before we attempt to start matching gestures
        /// </summary>
        ...
        /// </summary>
        private const string GestureSaveFileLocation = @"E:\";
        ...
        {
            //dtwTextOutput.Text = _dtw.RetrieveText();
            //KinectBlenderServer.PublishData("Gesture: " + _dtw.RetrieveText() + "\n");
        }
...
Ensure you have the Microsoft Speech SDK installed and configured.",
        ...
        //    private readonly double[] energy = new double[1500];
